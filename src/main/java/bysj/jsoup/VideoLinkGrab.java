...
public class VideoLinkGrab {
    ...
    public static void main(String[] args) {
        ...
        videoLinkGrab.saveData("https://www.80s.la/movie/list/-2015----p");
    }
    ...
    public void saveData(String baseUrl) {
        ...
        try {
            ...
            for (Map.Entry<String, String> mapping : videoLinkMap.entrySet()) {
                System.out.println("map:=> " + mapping.toString());
                        ...
                        if (isMoviePage(oldLink)) {
                            ...
                            while ((line = reader.readLine()) != null) {
                                ...
                                if (matcher.find()) {
                                    ...
                                    index++;
                                    System.out.println("index => "+ index+" 视频名称： "
                                            + title + "  ------  视频链接："
                                            + matcher.group(1));
                                    break;  //当前页面已经检测完毕
                                }
    ...
    public boolean checkUrl(String url) {
        Pattern pattern = Pattern.compile("https://www.80s.la/movie/list/-2015----p\\d*");
    ...
    public boolean isMoviePage(String url) {
        Pattern pattern = Pattern.compile("https://www.80s.la/movie/\\d+");
        Matcher matcher = pattern.matcher(url);
        if (matcher.find())
            return true;  //电影页面
        else
